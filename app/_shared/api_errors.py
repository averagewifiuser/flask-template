...
def permission_denied(message="You don't have the permissions to do that!"):
    return response_builder(403, message)

def food_already_allocated(name=None, message="This camper has already taken food today!"):
    if name:
        message = f"{name} has already taken food today!"
